...
<div class="col-md-7"><div style=" height:350px; width:500px; margin:100px;text-align:center; color: #ffffff; font-size:40px"><p style="font-family: monospace"><b>Welcome to Admission Academy.
</b></p><br>Kindly Sign-up yourself to give Scholarship Exam.</div></div>
<div class="col-md-4 panel">
<!-- sign in form begins -->  
  <form class="form-horizontal" name="form" action="sign.php?q=account.php" onSubmit="return validateForm()" method="POST">
<fieldset>

<b><p style="color:orange; font-size:24px;">Sign up</p></b>
<!-- Text input-->
<div class="form-group">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" required placeholder="Enter your mobile number" class="form-control input-md" type="number">
